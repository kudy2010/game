    ...
    return (React.createElement("div", null,
        ...
        React.createElement("div", { style: S.card },
            React.createElement("div", { style: { fontWeight: "bold", fontSize: 13, marginBottom: 1 } },
                "🎃 Three Cups ", React.createElement("span", { style: { fontSize: 10, color: "#7a6030", fontWeight: "normal" } }, "· Find the coin · Win 2.5×")),
        ...
        React.createElement("div", { style: S.card },
            React.createElement("div", { style: { fontWeight: "bold", fontSize: 13, marginBottom: 1 } },
                "🎲 Dice Roll ", React.createElement("span", { style: { fontSize: 10, color: "#7a6030", fontWeight: "normal" } }, "· HIGH/LOW 1.8× · SEVEN 5×")),
            ...
            dce.phase === "idle" ? (React.createElement("button", { onClick: playDice, disabled: gold < dce.bet, style: Object.assign({}, S.bigBtn, { width: "100%", textAlign: "center", fontSize: 13, padding: "9px", opacity: gold >= dce.bet ? 1 : 0.4 }) }, "🎲 Roll!")) : (React.createElement("div", { style: { textAlign: "center" } },
                ...
                React.createElement("div", { style: { fontSize: 11, color: "#9a7030", marginBottom: 3 } }, "Total: ", dce.r1 + dce.r2),
        ...
        React.createElement("div", { style: S.card },
            React.createElement("div", { style: { fontWeight: "bold", fontSize: 13, marginBottom: 1 } },
                "🃏 High Card ", React.createElement("span", { style: { fontSize: 10, color: "#7a6030", fontWeight: "normal" } }, "· Win 1.9× · Tie refunds")),
            React.createElement("div", { style: { display: "flex", gap: 7, alignItems: "center", marginBottom: 7 } },
