...
import { QUEST_ENEMIES, RARITY_COLOR, T } from '../data.js';
...
export function TravelScreen({ ts, onSkip }) {
    ...
    return React.createElement("div", { style: Object.assign({}, S.overlay, { justifyContent: "center", alignItems: "center", textAlign: "center", padding: 24 }) },
        ...
        React.createElement("div", { style: { fontSize: 11, color: "#7a6030", textTransform: "uppercase", letterSpacing: 2, marginBottom: 5 } }, T("Podróż do", "Travelling to")),
        React.createElement("div", { style: { fontSize: 20, fontWeight: "bold", marginBottom: 4 } }, name),
        isDungeon && React.createElement("div", { style: { fontSize: 12, color: RARITY_COLOR[ts.data.dungeon.lootTable], marginBottom: 8 } }, "★ ", ts.data.dungeon.lootTable, T(" łupy czekają ★", " loot awaits ★")),
        ...
        React.createElement("div", { style: { fontSize: 13, color: "#9a7030", marginBottom: 14 } },
            React.createElement("strong", null, enemy.name), T(" strzeże drogi", " guards the way")),
        ...
        React.createElement("button", { onClick: function() { SFX.enter(); onSkip(); }, style: Object.assign({}, S.bigBtn, { border: "2px solid #6a5020", color: "#9a7030", fontSize: 12 }) },
            T("⏩ Pomiń Podróż ", "⏩ Skip Travel "), React.createElement("span", { style: { fontSize: 10, color: "#5a4020" } }, "[ALPHA]")));
}
